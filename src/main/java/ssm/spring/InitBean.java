...
import ssm.constants.Constants;
import ssm.mybatis.MySqlSession;
...
public class InitBean extends BeanDefinition {
 ...
 /*       InitBean initBean = new InitBean();
        ...
        for (Map.Entry<String, Object> entry :
                entries) {
          *//*  if (entry.getKey().equals("ssm.demo.controller.RegisterController")) {
                RegisterController loginController = (RegisterController) entry.getValue();
                loginController.regeister();
            }*//*
            if (entry.getKey().equals("ssm.mybatis.JDBCUtils")) {
